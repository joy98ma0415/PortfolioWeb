<%@ Page Title="About" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="About.aspx.cs" Inherits="PortfolioWeb.About" %>
...
<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <table class="col-md-12" style="width: 100%; background-image: url('images/5-120601094P5-50.gif');">
        ...
        <tr>
            ...
            <h2 style="font-family: 標楷體">您好：</h2>
